...
public class VendorsMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call_customer = (ImageView) findViewById(R.id.call_icon);
        ...
        VendorId = Objects.requireNonNull(mAuth.getCurrentUser()).getUid();
        ...
        AssignedCustomerPickupRefListner = AssignedCustomerPickupRef.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot)
         {
           if(dataSnapshot.exists())
           {
               ...
               if (CustomerLocationMap != null && CustomerLocationMap.get(0) != null) {
                   LocationLat = Double.parseDouble(CustomerLocationMap.get(0).toString());


               }

               if (CustomerLocationMap != null && CustomerLocationMap.get(1) != null) {
