...
public class VendorLoginRegisterActivity extends AppCompatActivity {
    ...
    private TextView VendorLoginLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        VendorLoginLink = (TextView) findViewById(R.id.vendor_login_link);
        ...
        VendorLoginLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Alreadyreg. Login Now. with Register link text
                VendorLoginButton.setVisibility(View.VISIBLE);
                VendorRegisterButton.setVisibility(View.INVISIBLE);

                VendorLoginLink.setVisibility(View.INVISIBLE);
                VendorRegisterLink.setVisibility(View.VISIBLE);

                VendorLoginButton.setEnabled(true);
            }
        });
            ...
            { loadingBar.setTitle("Vendor Registration");
              ...
              mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task)
                    {
                      if(task.isSuccessful())
                      {
                          OnlineVendorId= Objects.requireNonNull(mAuth.getCurrentUser()).getUid();
